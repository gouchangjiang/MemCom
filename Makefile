...
lib-io-tree-postorder.o: src/lib-io-tree-postorder.cpp include/lib-io-tree-postorder.h lib-io-tree-utils.o
	$(CPP) $(INCLUDES) $(DEFS) $(CFLAGS) -o ${OBJ_PATH}/$@ -c $< -fPIC

lib-io-tree.o: src/lib-io-tree.cpp include/lib-io-tree.h lib-io-tree-postorder.o lib-io-tree-minmem.o lib-io-tree-utils.o lib-io-tree-liu-optimal.o
	$(CPP) $(INCLUDES) $(DEFS) $(CFLAGS) -o ${OBJ_PATH}/$@ -c $< -fPIC

heuristics.o: src/heuristics.cpp include/heuristics.hpp lib-io-tree-minmem.o lib-io-tree-liu-optimal.o lib-io-tree-postorder.o lib-io-tree.o
	$(CPP) $(INCLUDES) $(DEFS) $(CFLAGS) -o ${OBJ_PATH}/$@ -c $< -fPIC

heuristics:heuristics.o 
	rm -f ${LIB_PATH}/$@.a ${LIB_PATH}/$@.so
	ar rcs ${LIB_PATH}/$@.a $(OBJ_PATH)/heuristics.o $(OBJ_PATH)/lib-io-tree.o $(OBJ_PATH)/lib-io-tree-postorder.o $(OBJ_PATH)/lib-io-tree-utils.o $(OBJ_PATH)/lib-io-tree-minmem.o $(OBJ_PATH)/lib-io-tree-liu-optimal.o
